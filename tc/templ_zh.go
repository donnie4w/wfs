    ...
    <div class="modal fade" id="processpicModal" tabindex="-1" aria-labelledby="processpicModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                    ...
                    <div class="row g-2">
                        ...
                        <div class="col-1">
                            <div class="d-grid gap-2">
                                <button type="button" class="btn btn-secondary btn-sm" onclick="rotateLeft()">左转</button>
                                <button type="button" class="btn btn-secondary btn-sm" onclick="zoomIn()">放大</button>
                                <button type="button" class="btn btn-secondary btn-sm" onclick="fliph()">平翻</button>
                                <button type="button" class="btn btn-secondary btn-sm" onclick="invert()">反色</button>
                                <button type="button" class="btn btn-secondary btn-sm" onclick="picblur(0.5)">模糊</button>
                        ...
                        <div class="col-1">
                            <div class="d-grid gap-2">
                                <button type="button" class="btn btn-secondary btn-sm" onclick="rotateRight()">右转</button>
                                <button type="button" class="btn btn-secondary btn-sm" onclick="zoomOut()">缩小</button>
                                <button type="button" class="btn btn-secondary btn-sm" onclick="flipv()">竖翻</button>
                                <button type="button" class="btn btn-secondary btn-sm" onclick="grey()">灰色</button>
                                <button type="button" class="btn btn-secondary btn-sm" onclick="picblur(-0.5)">清晰</button>
                ...
                <div class="modal-footer">
                    <h6>更多图片处理请查看<a href="https://tlnet.top/wfsdoc" target="_blank">使用文档</a></h6>
            ...
            if (Array.isArray(fs) && fs.length > 0) {
                for (const item of fs) {
                    ...
                    let d = '<td style="font-weight: bold;">' + item.Id + '</td>'
                        ...
                        + '<td><button class="btn btn-primary m-1" onclick=\'processModalshow(' + item.Id + ',"' + aurl + item.Name + '")\';">图片处理</button><button class="btn btn-primary m-1" onclick=\'renameshow(' + item.Id + ',"' + item.Name + '")\';">重命名</button><button class="btn btn-primary" onclick=\'deletefile(this,"' + item.Name + '")\';">删除</button></td>'
                    tr.innerHTML = d;
